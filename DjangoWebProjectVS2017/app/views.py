...
def index(request):
    ...
    qs = qs.filter(question_subject = tema)
    context = {
...
def choice_add(request, question_id):
        ...
        if aux < 1:
            return render(request, 'polls/choice_new_less.html', {'title':'Pregunta:'+ question.question_text,'form': form})
            ...
            if aux == 1 or aux == 2:
                ...
                if aux == 3 or aux > 3:
                    return render(request, 'polls/choice_new_more.html', {'title':'Pregunta:'+ question.question_text,'form': form})
